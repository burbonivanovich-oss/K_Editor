 ...
 *
 * Основной сигнал «приехали новые темы» — не отсюда, а комментарий с
 * упоминанием: проверено 11.08.2026 на живом адресе, Google присылает
 * письмо от comments-noreply@docs.google.com с текстом комментария.
 * Отдельная автоматика для этого не нужна.
 *
 * Письма отсюда — запасной и ручной канал: когда нужно позвать редакцию
 * адресно, со счётчиками «сколько ждёт решения, сколько на вычитке», а не
 * ссылкой на комментарий. Требует авторизации скрипта владельцем.
 */
